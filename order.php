			...
			<div id="content">
				...
				<div class="bcolumn2">
                    <h2>HAVE A SPECIAL EVENT?</h2>
                     <p>Here at Cupcakes on a Cloud we bake from scratch each and every morning using only the highest quality, freshest ingredients available! Our bakers prepare 6-10 specialty cupcakes for you to enjoy in the shop or to go.</p>
                     <p>Our menu features a variety of cupcakes daily, each topped with swirls of icing in many traditional and modern flavors. The shop features new flavors each month and offer custom cupcakes for any occasion or special event.</p>
